        ...
        <div class="col-12 mb-md-0 mb-4">
          <div class="card">
            ...
            <div class="card-body px-4 pb-2">
              <form role="form text-left" action="{{ route('create_event_post') }}" method="POST">
                @csrf
                <div class="col-12 row">
                  ...
                  <div class="form-group col-2">
                    ...
                    <input type="number" name="vacancies_available" class="form-control" placeholder="" value="{{ old('vacancies_available') }}">
                  ...
                  <div class="form-group col-4">
                    ...
                    <input type="date" name="date_event" class="form-control" placeholder="Data" value="{{ old('date_event') }}">
                    @error('date_event')
                      <small class="text-danger">{{ $message }}</small>
                    @enderror
                  </div>
                  ...
                  <div class="form-group col-12">
                    ...
                    <input type="text" name="address" class="form-control" placeholder="Endereço" value="{{ old('address') }}">
                    @error('address')
                      <small class="text-danger">{{ $message }}</small>
                    @enderror
                  </div>
