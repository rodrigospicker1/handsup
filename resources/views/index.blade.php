@extends('layouts.app') <!-- Diz que esta página usa o layout -->
...
@section('content')
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{ route('dashboard') }}" target="_blank" style="display: flex; justify-content:center; jus">
        <img src="{{ asset('img/logo.png') }}" class="navbar-brand-img me-2" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item" >
          <a class="nav-link " href="{{ route('dashboard') }}" style="background-color: #40916C;color:white;border-radius:20px">
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                ...
                <a class="dropdown-item border-radius-md" href="{{ route('logout') }}"><span class="d-sm-inline d-none">Sair</span></a>
              </a>
            </li>
    ...
    <div class="container-fluid py-4">
                  ...
                  <div class="row" >
                    <div class="col-8 text-start" style="width:auto">
                      <div class="icon icon-shape bg-white shadow text-center border-radius-2xl" style="width:50%;display:flex;justify-content:center;align-items: center">
                        <img src="{{ asset('img/checkmark.png') }}" style="width:65%;height:70%" alt="" srcset="">
                      </div>
              ...
              <div class="card">
                ...
                <div class="card-body p-3 position-relative" style="background-color: #95D5B2; border-radius:10px">
                  <div class="row">
                    <div class="col-8 text-start" style="width:auto">
                      <div class="icon icon-shape bg-white shadow text-center border-radius-2xl" style="width:50%;display:flex;justify-content:center;align-items: center">
                        <img src="{{ asset('img/bell.png') }}" style="width:60%;height:60%" alt="" srcset="">
                      </div>
                      <h5 class="text-white font-weight-bolder mb-0 mt-3">
                        {{ $incritos }}
                      </h5>
                  ...
                  <div class="row">
                    <div class="col-8 text-start" style="width:auto">
                      <div class="icon icon-shape bg-white shadow text-center border-radius-2xl" style="width:40%;display:flex;justify-content:center;align-items: center">
                        <img src="{{ asset('img/racing-flag.png') }}" style="width:60%;height:60%" alt="" srcset="">
                      </div>
                      <h5 class="text-white font-weight-bolder mb-0 mt-3">
                        {{ $concluidos }}
                      </h5>
              ...
              <div class="card">
                ...
                <div class="card-body p-3 position-relative" style="background-color: #2D6A4F; border-radius:10px">
                  <div class="row">
                    <div class="col-8 text-start" style="width:auto">
                      <div class="icon icon-shape bg-white shadow text-center border-radius-2xl" style="width:40%;display:flex;justify-content:center;align-items: center">
                        <img src="{{ asset('img/schedule.png') }}" style="width:60%;height:60%" alt="" srcset="">
                      </div>
                      <h5 class="text-white font-weight-bolder mb-0 mt-3">
                        {{ $agendados }}
                      </h5>
      ...
      <div class="row my-4">
        ...
        <div class="col-12 d-flex">
          <a class="dropdown-item border-radius-md" href="{{ route('create_event') }}"><button type="button" style="background-color: #40916C;color:white" class="btn col-2">Criar evento</button></a>
        </div>
                  ...
                  <tbody>
                    @foreach($events as $event)
                        <tr>
                            ...
                            <td class="align-middle text-center text-sm">
                                <span class="text-xs font-weight-bold">{{ $event->vacancies_available }}</span>
                            </td>
                            <td class="align-middle text-center text-sm">
                                <span class="text-xs font-weight-bold">{{ $event->date_event }}</span>
                            </td>
                            <td class="align-middle text-center text-sm">
                                <span class="text-xs font-weight-bold">{{ $event->address }}</span>
                            </td>
                            <td class="align-middle text-center text-sm">
                                <span class="text-xs font-weight-bold">{{ $event->description }}</span>
                            </td>
                            <td class="align-middle text-center text-sm">
                            ...
                            <td class="align-middle text-center text-sm">
                              @if($event->is_subscribed)
                                <span class="badge bg-gradient-success">Inscrito</span>
                              @else
                                <form action="{{ route('subscribe_event') }}" method="POST">
                                  @csrf
  ...
  <script src="{{ asset('js/plugins/chartjs.min.j') }}"></script>
  <script>
