        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
              ...
              <p class="text-lead text-white">Crie sua conta e faça parte dessa comunidade</p>
            </div>
          </div>
        </div>
      </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mduda\Desktop\Rodrigo\projetos_laravel\full_service_project\resources\views/signup.blade.php ENDPATH**/ ?>